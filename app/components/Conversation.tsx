...
import { getConversations } from "~/server/chat.server";
...
function PAMOD_TECHNOLOGIE(besoin: string) {
  console.log("Besoin fournit===\n");
  console.log("Satisfaction totale du client");
  return;
}
